/**
 * k6 basic load test – 50 concurrent users, GET /api/v1/products
 * Run from repo root: k6 run load-testing/k6/basic-load-test.js
 * Run from this folder: k6 run basic-load-test.js
 * Override base URL: k6 run -e BASE_URL=http://localhost:8000 load-testing/k6/basic-load-test.js
 */
