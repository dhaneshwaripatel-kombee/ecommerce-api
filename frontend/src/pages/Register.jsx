    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4 py-16">
      ...
      <Card className="z-10 w-full max-w-lg border-white/5 shadow-netflix bg-white/[0.03] backdrop-blur-3xl overflow-hidden group">
        ...
        <CardHeader className="space-y-4 pb-4 pt-10 text-center">
          <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-primary shadow-glow-red transform group-hover:rotate-12 transition-transform duration-500">
        ...
        <CardContent className="pt-6 px-10">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button type="submit" className="h-14 w-full text-lg font-black uppercase tracking-widest bg-primary text-white shadow-glow-red hover:shadow-primary/40 mt-4" disabled={loading}>
              {loading ? (
                <>
